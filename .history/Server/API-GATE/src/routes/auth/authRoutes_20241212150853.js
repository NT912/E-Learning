 ...
 *     description: "This endpoint allows creating a new admin account. The 'role' is automatically set to 'admin'."
 ...
 *       - name: "body"
 *         in: "body"
 *         description: "The user details for the new admin account."
 *         required: true
 *         schema:
 *           type: "object"
 *           properties:
 ...
 *     responses:
 *       200:
 *         description: "Successful response with the created admin account details."
 *         schema:
 *           type: "object"
 *           properties:
 *             message:
 ...
 *             error:
 *               type: "string"
 *               example: "Error details from service"
 */
// Route cho signupAdmin
router.post("/signupadmin", async (req, res) => {
  try {
    // Kiểm tra xem body có hợp lệ hay không
    ...
    const signupData = {
      ...req.body,
      role: "admin", // Gán role mặc định là admin
    };

    console.log(
      "Calling signupAdmin API with URL:",
      `${AUTH_SERVICE_URL}/auth/signupadmin`
    );
