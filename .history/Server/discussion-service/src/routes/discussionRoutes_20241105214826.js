 ...
 *     description: Allows authenticated users to create a new discussion topic within a specified course.
 *     tags:
 *       - Discussions
 *     security:
 ...
 *         schema:
 *           type: integer
 *         description: ID of the course to create the discussion in
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *                 example: "Discussion about course materials"
 *               content:
 *                 type: string
 *                 description: Content of the discussion
 *                 example: "I have a question about the lecture from last week..."
 *     responses:
 *       201:
 ...
 *                 description:
 *                   type: string
 *                   example: "The discussion has been created successfully."
 *                 data:
 *                   type: object
 *                   properties:
 *                     discussionID:
 ...
 *                       example: "I have a question about the lecture from last week..."
 *       400:
 *         description: Bad request - Invalid or missing fields in discussion data
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 description:
 *                   type: string
 *                   example: "Title and content are required fields."
 *       401:
 ...
 *                 description:
 *                   type: string
 *                   example: "Course with the specified ID not found."
 */
router.post(
  "/courses/:courseID/discussions",
  authMiddleware.verifyToken,
  discussionValidation.validateDiscussion,
 ...
 *     description: Retrieve a list of discussions related to a specific course. This endpoint is accessible to authenticated users.
 *     tags:
 *       - Discussions
 *     security:
 *       - bearerAuth: []  # Requires JWT token in Authorization header
 ...
 *         schema:
 *           type: integer
 *         description: ID of the course for which to retrieve discussions
 *     responses:
 *       200:
 ...
 *                       content:
 *                         type: string
 *                         example: "This is a discussion content."
 *                       author:
 *                         type: string
 *                         example: "student1"
 *                       createdAt:
