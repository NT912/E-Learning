...
router.post(
  "/confirm/:courseID",
  authMiddleware.verifyToken,
  courseController.confirm
);

// shortcut
router.post(
  "/update/shortcut/:courseID",
  authMiddleware.verifyToken,
  courseValidator.updateCourseShortcut,
  courseController.updateCourseShortcut
);

// description
router.post(
  "/update/description/:courseID",
  authMiddleware.verifyToken,
  courseValidator.updateCourseDescription,
  courseController.updateCourseDescription
);

// description
router.post(
  "/update/cost/:courseID",
  authMiddleware.verifyToken,
  courseValidator.updateCourseCost,
...
router.post(
  "/lesson/update/allowDemo/:lessonID",
  authMiddleware.verifyToken,
  lessonController.updateLessonAllowDemo
);
